...
const createUser = async function (req, res) {
    try {
        ...
        const { fname, lname, email, phone, password, address,DOB } = data
    ...
    let profileImage1 = await imgUpload.uploadFile(files[0])   // AWS
        ...
        let obj = {
            fname, lname, email, phone, password: encyptPassword, address: addressParse,profileImage: profileImage1,DOB:DOB
        }
...
const loginUser =
    async function (req, res) {
        try {
            ...
            }, "Devstree.com@VeryVerySecure", { expiresIn: '25h' })
...
const updateUserProfile = async (req, res) => {
    try {
        ...
        const { fname, lname, email, profileImage, phone, password, address,DOB } = req.body
